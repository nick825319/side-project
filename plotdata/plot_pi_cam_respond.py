...
fdata = np.loadtxt(exp_path + 'pi_measure_cam_respond.txt', delimiter = ' ')
...
ax.set_ylabel('cam_respond_time(sec)')
ax.set_title('pi_camera_respond_time')
...
plt.savefig('./pi_measure_cam_respond.pdf')
plt.show()
