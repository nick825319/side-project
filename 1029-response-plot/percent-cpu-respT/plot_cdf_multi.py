...
str_cpu_utility = [ 60, 70, 80, 90, 100]
...
for x in str_cpu_utility:
    dir_name = "./" + str(x) + "cpu-respT/"
    data_name = "measure_fullPathTime_byPi_filte.txt"
...
plt.xticks(np.arange(int(min(rt_Sorted[0]))-50, 370, 20), rotation=60)
